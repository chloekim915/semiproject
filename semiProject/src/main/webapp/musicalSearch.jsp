...
<%@include file="/views/common/header.jsp"%>
    ...
    <!-- 검색 -->
    <form class="container position-relative zindex-5"  action="<%=path%>/musicalSearch" method="get">
    ...
    <!-- Page content-->
    <div class="container py-4 mb-20 mb-sm-0 pb-sm-10" style="margin-top:100px;">
        <nav aria-label="breadcrumb">
        </nav>

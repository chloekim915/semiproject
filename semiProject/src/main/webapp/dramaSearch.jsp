...
<form class="container position-relative zindex-5"
	...
	<div
		...
		<div class="d-sm-flex align-items-center flex-grow-1">
			...
			<div class="mb-3 pb-1 w-100 mb-sm-4 me-sm-3">
				<label class="form-label" for="to-destination">출연진</label> <input
					class="form-control me-3" name="prfcastValue" type="text">
			</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 ">
                       ...
                       <article class="card card-horizontal card-hover mb-grid-gutter ">
                            <a class="card-img-top" href="#" style="background-image: url(<%=searchList.get(i).getPoster() %>);"></a>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 ">
                        <!-- Post-->
                         ...
                         <div class="pb-2" style="width:500px; height:700px; margin-left: 90px; ">
                        <a class="card border-0 shadow card-hover mx-1" href="<%=path %>/showSelect?prfid=<%=searchList.get(0).getPrfid() %>">
                            <div class="card-img-top card-img-gradient"><img src="  <%= searchList.get(0).getPoster() %> " alt="Burano"><span class="card-floating-text text-light fw-medium">자세히 보기<i class="ai-chevron-right align-middle fs-lg ms-1"></i></span></div>
                            <div class="card-body text-center">
                                <h3 class="h5 pt-1 mb-3"><%= searchList.get(0).getPrfnm() %></h3>
                                <p class="fs-sm text-muted mb-2"><%= searchList.get(0).getPrfcast() %></p>
                                <p class="fs-sm text-muted mb-2"><%= searchList.get(0).getPrfpdfrom() %>~<%= searchList.get(0).getPrfpdto() %></p>
                            </div>
                        </a>
                    </div>
                        <%} %><%else { %>
                       ...
                       <article class="card card-horizontal card-hover mb-grid-gutter ">
                            <a class="card-img-top" href="#" style="background-image: url(<%=searchList.get(i).getPoster() %>);"></a>
                            <div class="card-body">
                                <h2 class="h4 nav-heading text-capitalize mb-3"><a href="<%=path %>/showSelect?prfid=<%=searchList.get(i).getPrfid() %>"><%= searchList.get(i).getPrfnm() %></a></h2>
                                <p class="mb-0 fs-sm text"> <%= searchList.get(i).getPrfruntime() %> | <%= searchList.get(i).getPrfage()%></br>
                                    출연 : <%=searchList.get(i).getPrfcast() %>
                                </p>
                            </div>

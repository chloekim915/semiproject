...
<%@include file="/views/common/header.jsp"%>
    <!-- 검색 시작 -->
    <form class="container position-relative zindex-5"  action="<%=path%>/classicSearch" method="get">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 ">
                       ...
                       <article class="card card-horizontal card-hover mb-grid-gutter ">
                            ...
                            <div class="card-body">
                                <h2 class="h4 nav-heading text-capitalize mb-3"><a href="<%=path %>/classicSelect?prfid=<%=searchList.get(i).getPrfid() %>"><%= searchList.get(i).getPrfnm() %></a></h2>

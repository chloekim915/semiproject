    ...
    <header>
        <nav class="navbar_custom">
            <div class="navbar_logo_custom" style="margin-left: 150px; padding: bottom 80px;">
                <a href="<%=path %>/main2"> <!-- 메인 추가 수정 요구 -->
                    <img src="logo_ver3.svg" class="navbar-brand-logo_custom" style="color:#F4EFEA; width:120px; height:70px;">
                </a>
            ...
            <nav class="navbar_menu_custom" style="margin-bottom:-60px; ">
                <ul class="navbar_menu_custom">
                    <li class="nav-item "><a href="<%=path %>/main2">홈</a></li> <!-- 연결 예정 메인 추가 수정 요구 -->
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="board">
                            ...
                            <li><a class="dropdown-item" href="<%=path %>/review_list">리뷰게시판</a></li> <!-- 연결 예정 -->
            ...
            <ul class="navbar_icons_custom " style="margin-top:-30px;">
            	<% if(loginMember != null){ %>
					<li>

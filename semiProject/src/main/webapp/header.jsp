    ...
    <header>
        <nav class="navbar_custom">
            <div class="navbar_logo_custom" style="margin-left: 150px; padding: bottom 80px;">
                <a href="<%=path %>/main2.html">
                    <img src="logo_bigger.svg" class="navbar-brand-logo_custom" style="width:120px; height:120px;">
                </a>
            ...
            <nav class="navbar_menu_custom" style="margin-bottom:-60px; ">
                <ul class="navbar_menu_custom">
                    <li class="nav-item "><a href="<%=path %>/main2.jsp">홈</a></li>
                    <li class="nav-item "><a href="<%=path %>/musical.jsp">뮤지컬</a></li>
                    <li class="nav-item"><a href="<%=path %>/drama.jsp">연극</a></li>
                    <li class="nav-item "><a href="<%=path %>/classic.jsp">클래식</a></li>
                    <li class="nav-item "><a href="<%=path %>/korean.jsp">국악</a></li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="board">
                            <li><a class="dropdown-item" href="<%=path %>/notice_list.jsp">공지게시판</a></li>
                            <li><a class="dropdown-item" href="<%=path %>/review_list.jsp">리뷰게시판</a></li>
                            <li><a class="dropdown-item" href="<%=path %>/QnA_list.jsp">문의게시판</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>

...
@WebServlet("/musicalSearch")
public class MusicalSearch extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Searchlist = service.findMusicalDetail(searchMap);
		...
		req.getRequestDispatcher("/musicalSearch.jsp").forward(req, resp);
